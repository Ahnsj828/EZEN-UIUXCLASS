...
// -----------------------------------
// btn1을 누를 때 11760을 빼고, btn2를 누를 때 18800을 빼는 기능 추가
const btn1 = document.querySelector(".btn-clear.btn1");
const btn2 = document.querySelector(".btn-clear.btn2");

btn1.addEventListener("click", () => {
  priceSum.forEach((price) => {
    const currentPrice = parseInt(price.textContent.replace("원", "").replace(",", ""));
    const newPrice = currentPrice - b;
