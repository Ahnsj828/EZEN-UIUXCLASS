...
import { fetchCoins } from "../api"; // 외부 api를 담고있는애
import { useQuery } from "react-query"; // 외부 api를 전달해줄 애
...
const Conins = () => {
  ...
  //   })();
  // }, []);
  // // async라는 비동기 함수를 써서 외부데이터를 가져왔다

  // 👇🏼 fetchCoins, useQuery 사용하는걸로 변경할거다

  const { isLoading, data } = useQuery<CoinInterface>("allCoins", fetchCoins);
  // data => fetchCoins로 가져온 값
  // allCoins라는 이름으로
  // fetchCoins => 코인즈한테 전달하고자 하는 데이터
