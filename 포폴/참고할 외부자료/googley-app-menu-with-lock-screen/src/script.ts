    ...
    <div id="app-menu">      
      <div id="app-menu-content-wrapper">
        <div id="app-menu-content">
          ...
          <QuickNav />
          <a id="youtube-link" className="clear-button" href="https://www.youtube.com/c/FrontEndDevYT?sub_confirmation=1" target="_blank">
...
const App: React.FC = () => {
  const [userStatus, setUserStatusTo] = React.useState<UserStatus>(UserStatus.LoggedIn);
